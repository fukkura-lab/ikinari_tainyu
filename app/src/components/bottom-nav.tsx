...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-50 bg-surface/80 glass-header rounded-t-[2.5rem] shadow-[0_-12px_32px_rgba(170,44,50,0.06)] border-t border-outline-variant/10">
      <div className="max-w-md mx-auto flex justify-around items-center px-4 pt-2 pb-8">
        {navItems.map((item) => {
